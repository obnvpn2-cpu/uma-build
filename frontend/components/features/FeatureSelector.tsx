  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-mincho text-lg font-bold">特徴量を選択</h2>
          <div className="flex items-center gap-2 mt-1">
            <p className="text-xs text-text-muted">
              AIが学習に使うデータ項目を選びましょう
            </p>
            <span className="inline-flex items-center gap-1 text-xs font-mono px-2.5 py-1 rounded-full bg-accent/15 text-accent border border-accent/30">
